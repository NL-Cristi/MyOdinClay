...
allFilters := [26]Filter{
    {enabled = true, excluding = false, description = "Filter A", backColor = "Purple", foreColor = "White", type = "matches_text", case_sensitive = false, regex = false, text = "apple", hits = 5, letter = "a"},
    {enabled = true, excluding = false, description = "Filter B", backColor = "Red", foreColor = "White", type = "matches_text", case_sensitive = false, regex = false, text = "brown", hits = 3, letter = "b"},
    {enabled = false, excluding = true, description = "Filter C", backColor = "Blue", foreColor = "White", type = "matches_text", case_sensitive = true, regex = false, text = "cat", hits = 7, letter = "c"},
    {enabled = true, excluding = false, description = "Filter D", backColor = "Green", foreColor = "Black", type = "matches_text", case_sensitive = false, regex = false, text = "dog", hits = 9, letter = "d"},
    {enabled = false, excluding = false, description = "Filter E", backColor = "Yellow", foreColor = "Black", type = "matches_text", case_sensitive = false, regex = false, text = "elephant", hits = 2, letter = "e"},
    {enabled = true, excluding = true, description = "Filter F", backColor = "Orange", foreColor = "Black", type = "matches_text", case_sensitive = true, regex = false, text = "fox", hits = 4, letter = "f"},
    {enabled = true, excluding = false, description = "Filter G", backColor = "Purple", foreColor = "White", type = "matches_text", case_sensitive = false, regex = false, text = "grape", hits = 6, letter = "g"},
    {enabled = false, excluding = false, description = "Filter H", backColor = "Red", foreColor = "White", type = "matches_text", case_sensitive = false, regex = false, text = "horse", hits = 8, letter = "h"},
    {enabled = true, excluding = false, description = "Filter I", backColor = "Blue", foreColor = "White", type = "matches_text", case_sensitive = true, regex = false, text = "ice", hits = 1, letter = "i"},
    {enabled = false, excluding = true, description = "Filter J", backColor = "Green", foreColor = "Black", type = "matches_text", case_sensitive = false, regex = false, text = "jacket", hits = 3, letter = "j"},
    {enabled = true, excluding = false, description = "Filter K", backColor = "Yellow", foreColor = "Black", type = "matches_text", case_sensitive = false, regex = false, text = "kite", hits = 5, letter = "k"},
    {enabled = false, excluding = false, description = "Filter L", backColor = "Orange", foreColor = "Black", type = "matches_text", case_sensitive = true, regex = false, text = "lion", hits = 7, letter = "l"},
    {enabled = true, excluding = true, description = "Filter M", backColor = "Purple", foreColor = "White", type = "matches_text", case_sensitive = false, regex = false, text = "mouse", hits = 9, letter = "m"},
    {enabled = false, excluding = false, description = "Filter N", backColor = "Red", foreColor = "White", type = "matches_text", case_sensitive = false, regex = false, text = "notebook", hits = 2, letter = "n"},
    {enabled = true, excluding = false, description = "Filter O", backColor = "Blue", foreColor = "White", type = "matches_text", case_sensitive = true, regex = false, text = "orange", hits = 4, letter = "o"},
    {enabled = false, excluding = true, description = "Filter P", backColor = "Green", foreColor = "Black", type = "matches_text", case_sensitive = false, regex = false, text = "pencil", hits = 6, letter = "p"},
    {enabled = true, excluding = false, description = "Filter Q", backColor = "Yellow", foreColor = "Black", type = "matches_text", case_sensitive = false, regex = false, text = "queen", hits = 8, letter = "q"},
    {enabled = false, excluding = false, description = "Filter R", backColor = "Orange", foreColor = "Black", type = "matches_text", case_sensitive = true, regex = false, text = "rabbit", hits = 1, letter = "r"},
    {enabled = true, excluding = true, description = "Filter S", backColor = "Purple", foreColor = "White", type = "matches_text", case_sensitive = false, regex = false, text = "snake", hits = 3, letter = "s"},
    {enabled = false, excluding = false, description = "Filter T", backColor = "Red", foreColor = "White", type = "matches_text", case_sensitive = false, regex = false, text = "tiger", hits = 5, letter = "t"},
    {enabled = true, excluding = false, description = "Filter U", backColor = "Blue", foreColor = "White", type = "matches_text", case_sensitive = true, regex = false, text = "umbrella", hits = 7, letter = "u"},
    {enabled = false, excluding = true, description = "Filter V", backColor = "Green", foreColor = "Black", type = "matches_text", case_sensitive = false, regex = false, text = "violin", hits = 9, letter = "v"},
    {enabled = true, excluding = false, description = "Filter W", backColor = "Yellow", foreColor = "Black", type = "matches_text", case_sensitive = false, regex = false, text = "window", hits = 2, letter = "w"},
    {enabled = false, excluding = false, description = "Filter X", backColor = "Orange", foreColor = "Black", type = "matches_text", case_sensitive = true, regex = false, text = "xylophone", hits = 4, letter = "x"},
    {enabled = true, excluding = true, description = "Filter Y", backColor = "Purple", foreColor = "White", type = "matches_text", case_sensitive = false, regex = false, text = "yellow", hits = 6, letter = "y"},
    {enabled = false, excluding = false, description = "Filter Z", backColor = "Red", foreColor = "White", type = "matches_text", case_sensitive = false, regex = false, text = "zebra", hits = 8, letter = "z"},
}
...
MenuBarItem :: proc(category: string, index: int, open_menu: ^string) {
    if clay.UI()({
        ...
        layout = {
            sizing = { width = clay.SizingGrow({ max = 120 }) },
            padding = { 16, 16, 8, 8 },
        },
...
TextScrollContainer :: proc() {
    if clay.UI()({
        ...
        layout = {
            layoutDirection = .TopToBottom,
            sizing = { width = clay.SizingGrow({}), height = clay.SizingGrow({ min = 250 }) },
...
FilterRow :: proc(filter: Filter, index: int) {
    ...
    if clay.UI()({
        id = clay.ID("FilterRow", u32(index)),
        layout = {
            sizing = { width = clay.SizingGrow({}) },
            padding = clay.PaddingAll(5),
        },
...
FilterScrollContainer :: proc() {
    if clay.UI()({
        ...
        layout = {
            layoutDirection = .TopToBottom,
            sizing = { width = clay.SizingGrow({}), height = clay.SizingGrow({ min = 300 }) },
            padding = clay.PaddingAll(10),
            childGap = 0,
        },
        backgroundColor = COLOR_LIGHT,
